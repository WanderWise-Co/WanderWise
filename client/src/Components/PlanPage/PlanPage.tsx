    ...
    <>
      ...
      <div className={styles.planPageContainer}>
        <div className={styles.contentContainer}>
          ...
          ):navButton === "renting" ? (<CarRental rentals={transportRentalData ?.car_rentals || []}  />): navButton === "recommendations" || navButton === "restaurants" || navButton === "hotels" || navButton === "attractions" ? (
            <PlacesList
              places={places}
